...
1. Go to the [**Releases page**](https://github.com/PythonWoods/zenzic-vscode/releases/latest) and download the latest `.vsix` file (e.g. `zenzic-vscode-0.22.1.vsix`).
...
- **Zenzic is not installed:** Install it with `uv tool install zenzic==0.22.1`.
